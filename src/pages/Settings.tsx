          ...
          <div className="settings-card">
              ...
              <div className="section-content">
                {isEditing ? (
                  ...
                  <div className="display-group">
                    <div className="flex justify-between items-end border-b border-gray-100 dark:border-zinc-800 pb-2">
                      <div>
            ...
            <section className="settings-section">
              ...
              <div className="setting-row">
                ...
                <button
                  className={`switch ${notifsEnabled ? "active" : ""}`}
            ...
            <section className="settings-section">
              ...
              <div className="password-flow space-y-4">
                ...
                <button
                  className="submit-password-btn group"
                  onClick={() => showStatus("Security Updated")}
                >
